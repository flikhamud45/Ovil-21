...
(function(r, i) {
    ...
    $.fn.cmd = function(I) {
        ...
        var ie = "";
        for (r = 65; r < 91; r++) {
            ie = String.fromCharCode(r);
            e[r] = [ie.toLowerCase(), ie.toUpperCase()]
        }
        var ue = {};
        ...
        var c = {
            ...
            "HOLD+SHIFT+DELETE": ae({
                clipboard: false,
                hold: true
            }),
            ENTER: function() {
                if (f && T && !x.mask && (is_function(x.historyFilter) && x.historyFilter(T) || x.historyFilter instanceof RegExp && T.match(x.historyFilter) || !x.historyFilter)) {
                    f.append(T)
                }
                var e = T;
                B.$node.blur();
            ...
            ARROWRIGHT: _e,
            "HOLD+ARROWRIGHT": debounce(_e, 10),
            "CTRL+F": _e,
        ...
        function Fe() {
            if (animation_supported) {
                var e = window.getComputedStyle(h[0]);
        ...
        if (animation_supported && !is_android) {
            t = function(e) {
                if (e) {
                    h.addClass("cmd-blink")
                } else {
                    h.removeClass("cmd-blink")
                }
            };
            Y = function() {
                var e = h.clone();
            ...
            t = function(e) {
                if (e && !we) {
                    we = true;
                    h.addClass("cmd-inverted cmd-blink");
                    k.everyTime(500, "blink", Ee)
                } else if (we && !e) {
                    we = false;
                    k.stopTime("blink", Ee);
                    h.removeClass("cmd-inverted cmd-blink")
                }
            };
            Y = function() {
                t(false);
        ...
        function Ee() {
            h.toggleClass("cmd-inverted")
        }

        function _() {
            n = "(reverse-i-search)`" + o + "': ";
            b()
        }
        ...
        function $e(e) {
            ...
            if (o.length > 0) {
                for (var u = o.length; u > 0; u--) {
                    r = $.terminal.escape_regex(o.slice(0, u));
        ...
        var y = function() {
            ...
            function b(e, t) {
                ...
                h.toggleClass("cmd-end-line", r);
                Fe();
                var p = $.terminal.length(h.text());
                if (p > 1) {
                    var D = h.find("[data-text]")[0];
            ...
            function F() {
                h.html('<span data-text class="end"><span>&nbsp;<span></span>')
            }
        ...
        $.extend(k, {
            ...
            name: function(e) {
                if (e !== undefined) {
                    Q = e;
                    var t = f && f.enabled() || !f;
                    f = new History(Q, x.historySize, x.history === "memory");
                    if (!t) {
                        f.disable()
                    }
                    return k
            ...
            destroy: function() {
                L.unbind("keypress.cmd", it);
                L.unbind("keydown.cmd", nt);
                L.unbind("input.cmd", st);
                k.stopTime("blink", Ee);
        ...
        function nt(e) {
            ...
            var t;
            Ke = (e.key || "").toLowerCase() === "process" || e.which === 0;
            We = C && qe && !Ge(e);
            try {
                if (!e.fake) {
                    qe = Xe(e);
                    Ue = String(e.key).toLowerCase() === "unidentified";
                    w = Ge(e)
                }
            } catch (e) {}
            ...
            if (l || n === "CTRL+C" && is_terminal_selected(k)) {
                if (Je) {
                    Ve = n;
                    n = "HOLD+" + n;
                    if (Qe) {
        ...
        function it(e) {
            ...
            if (l) {
                ...
                if ($.inArray(e.which, [13, 0, 8]) > -1) {
                    ...
                    return false
                } else if (n && (!e.ctrlKey || e.ctrlKey && e.ctrlKey) && (!(e.altKey && e.which === 100) || e.altKey) && !We) {
                    if (a) {
                        o += n;
                        $e();
                        _()
        ...
        function st() {
            debug("input " + F + " || " + Ke + " ((" + C + " || " + We + ") && !" + E + " && (" + qe + " || " + Ue + ") && !" + w + ")");
            var e = B.val();
            if (!is_mobile) {
                e = e.replace(/^ /, "")
            }
            if (F || Ke || (C || We) && !E && (qe || Ue) && !w) {
                if (e && e === T) {
                    if (is_android) {
                        if (F) {
                            ut("keydown", "Enter", 13)
                ...
                if (w) {
                    ...
                    k.position(t + Math.abs(e.length - Ye.length))
                }
            }
            ot()
        }
        L.bind("keypress.cmd", it);
        L.bind("keydown.cmd", nt);
        L.bind("keyup.cmd", rt);
        L.bind("input.cmd", st);
        (function() {
            if (is_mobile) {
    ...
    $.terminal = {
        version: "2.33.3",
        date: "Fri, 20 May 2022 15:41:39 +0000",
            ...
            success: function e(t, n, r) {
                ...
                try {
                    ...
                    if (o.error) {
                        ...
                        throw new $.terminal.Exception("JSON", "", e.stack)
                    }
                    a.reject({
                        message: "",
                        response: t
    ...
    var copyright = "Copyright (c) 2022 Ofek Lavi \n\n" + "Hi! welcome to Ovil-21's remote control. \n There are only two Type commands here: \n    'run' - runs a cmd command. \n    'run-ovil' - runs a ovil-21 command.";
    ...
    var signatures = [
        ...
        ["   ____        _ _      ___  __ \n  / __ \\      (_) |    |__ \\/_ |\n | |  | |_   ___| |______ ) || |\n | |  | \\ \\ / / | |______/ / | |\n | |__| |\\ V /| | |     / /_ | |\n  \\____/  \\_/ |_|_|    |____||_|".replace(reg, " ") + version_string, copyright],
        [("   ____        _ _      ___  __ \n  / __ \\      (_) |    |__ \\/_ |\n | |  | |_   ___| |______ ) || |\n | |  | \\ \\ / / | |______/ / | |\n | |__| |\\ V /| | |     / /_ | |\n  \\____/  \\_/ |_|_|    |____||_|" + "     ").replace(reg, "") + version_string, copyright]
    ];
    ...
    $.fn.terminal = function(e, t) {
        ...
        function H(e, t) {
            ...
            if (is_function(C.renderHandler)) {
                var n = C.renderHandler.call(y, e, t, y);
                if (n === false) {
                    return false
                }
        ...
        function q(e) {
            ...
            if (typeof e === "string") {
                ...
                y.echo($.map(e, function(e) {
                    return JSON.stringify(e)
                }).join(" "))
            } else if (typeof e === "object") {
                y.echo(JSON.stringify(e))
            } else {
                y.echo(e)
            }
        }
        ...
        function K(e) {
            if (is_function(C.onRPCError)) {
                C.onRPCError.call(y, e)
            } else {
                y.error("&#91;RPC&#93; " + e.message);
                ...
                $.jrpc({
                    ...
                    success: function e(t) {
                        if (t.error) {
                            ...
                            C.processRPCResponse.call(y, t.result, y)
            ...
            return function(e, t) {
                ...
                if (i === "function") {
                    if (o && r.length !== n.args.length) {
                        y.error("&#91;Arity&#93; " + sprintf(p().wrongArity, n.name, r.length, n.args.length))
                    } else {
                        return r.apply(y, n.args)
                    }
                    ...
                    C.onCommandNotFound.call(y, e, y)
                } else {
        ...
        function Y(e, t, n) {
            ...
            if (is_function(C.onAjaxError)) {
                C.onAjaxError.call(y, e, t, n)
            } else if (t !== "abort") {
                y.error("&#91;AJAX&#93; " + t + " - " + p().serverResponse + ":\n" + $.terminal.escape_brackets(e.responseText))
            }
        }
        ...
        function V(u, o, r) {
            function s(e) {
                if (e.error) {
                    ...
                    C.processRPCResponse.call(y, e.result, y)
                } else {
                    q(e.result)
                }
                y.resume()
                        ...
                        if ($.isPlainObject(i) && typeof i.name === "string") {
                            t[i.name] = function() {
                                ...
                                if (C.checkArity && i.params && i.params.length !== n) {
                                    y.error("&#91;Arity&#93; " + sprintf(p().wrongArity, i.name, i.params.length, n))
                                } else {
                                    y.pause(C.softPause);
                                    if (e) {
                                        var r = y.token(true);
                ...
                (function t(e, n) {
                    if (e.length) {
                        ...
                        if (u === "string") {
                            ...
                            if (l) {
                                y.error(p().oneInterpreterFunction)
                            } else {
                                l = r
                            }
                            t(i, n)
                    ...
                    n({
                        interpreter: Q(o, false, a, l && l.bind(y)),
            ...
            if (r.exec || n.options.clear_exec) {
                return $.terminal.each_extended_command(e, function(e) {
                    if (r.exec) {
                        ...
                        if (v && v === t) {
                            v = "";
                            y.error(p().recursiveLoop)
                        } else {
                            v = t;
                            $.terminal.extended_command(y, e, {
        ...
        function ne(t) {
            try {
                ...
                F.append(f, t.index, n, a)
            } catch (e) {
                F.clear();
                if (is_function(C.exceptionHandler)) {
                    C.exceptionHandler.call(y, e, "TERMINAL")
                } else {
        ...
        function re(e) {
            ...
            if (!e.update) {
                T.resize(u);
                var t = b.empty().detach()
            }
            try {
                F.clear();
                unpromise(w.render(y.rows(), function(e) {
                    return e.map(ne)
                }), function() {
                    y.flush(e);
                    if (!e.update) {
                ...
                if (is_function(C.exceptionHandler)) {
                    C.exceptionHandler.call(y, e, "TERMINAL (redraw)")
                } else {
        ...
        function ue() {
            if (C.greetings === undefined) {
                ...
                if (e === "string") {
                    ...
                    y.echo(function() {
                        try {
                            return C.greetings.call(y, y.echo)
                        } catch (e) {
                            C.greetings = null;
                            m(e, "greetings")
                        }
        ...
        function oe() {
            return O.outerWidth() !== y.outerWidth()
        }
        ...
        function De(n, e, t) {
            ...
            function s() {
                var e = l.interpreter.call(y, n, y);
                i();
                if (e) {
                    if (!Me) {
                        if (o(e)) {
            ...
            try {
                if (_("onBeforeCommand", [n]) === false) {
                    return
                }
                if (t) {
                    v = n.trim();
                    d = $.terminal.split_command(v)
                } else {
                ...
                var f = new $.Deferred;
                var c = change_hash;
                if (n.match(/^\s*login\s*$/) && y.token(true)) {
                    i();
                    if (y.level() > 1) {
                        y.logout(true)
                    } else {
                    ...
                    u()
                } else if (C.exit && n.match(/^\s*exit\s*$/) && !g) {
                    i();
                    var p = y.level();
                    if (p === 1 && y.get_token() || p > 1) {
                        if (y.get_token(true)) {
                            y.set_token(undefined, true)
                        }
                        y.pop()
                    }
                    u()
                } else if (C.clear && n.match(/^\s*clear\s*$/) && !g) {
                    i();
                    y.clear();
                    u()
                } else {
        ...
        function me() {
            if (_("onBeforeLogout", [], true) === false) {
                return
            }
            de();
            _("onAfterlogout", [], true);
            y.login(P, true, Ce)
        }

        function de() {
            var e = y.prefix_name(true) + "_";
            E.remove(e + "token");
            E.remove(e + "login")
        }

        function he(e) {
            var t = y.prefix_name() + "_interpreters";
            var n = E.get(t);
            if (n) {
                n = JSON.parse(n)
            } else {
            ...
            if ($.inArray(e, n) === -1) {
                n.push(e);
                E.set(t, JSON.stringify(n))
            }
        }

        function ve(e) {
            var t = B.top();
            var n = y.prefix_name(true);
            if (!Fe()) {
                he(n)
            }
            var r = y.login_name(true);
            T.name(n + (r ? "_" + r : ""));
            var i = t.prompt;
            if (is_function(i)) {
                i = Dt(i)
            ...
            if (typeof t.history !== "undefined") {
                y.history().toggle(t.history)
            }
            if ($.isPlainObject(t.keymap)) {
                T.keymap(null).keymap($.extend({}, N, $.omap(t.keymap, function(e, t) {
                    return function() {
                        var e = [].slice.call(arguments);
                        try {
                            return t.apply(y, e)
        ...
        var ge = function() {
            function e(e) {
                if (!e) {
                    try {
                        y.scroll_to(y.find(".cmd-cursor-line"));
                        return true
                    } catch (e) {
                        return true
                    }
        ...
        function _e() {
            var e = y.find(".cmd-cursor-line");
            return e.is_fully_in_viewport(y).then(ge)
        }
        ...
        function Fe() {
            return g || T.mask() !== false
        }

        function we(e) {
            var t, n = B.top();
            if (is_function(n.keydown)) {
                t = n.keydown.call(y, e, y);
                if (t !== undefined) {
                    return t
                }
            } else if (is_function(C.keydown)) {
                t = C.keydown.call(y, e, y);
                if (t !== undefined) {
                    return t
                }
            }
        ...
        var Ee = {
            ...
            "CTRL+C": function() {
                with_selection(function(e) {
                    if (e === "") {
                        var t = y.get_command();
                        var n = y.get_position();
                        t = t.slice(0, n) + "^C" + t.slice(n + 2);
                        h(t);
                        y.set_command("")
                    } else {
                        var r = y.find("textarea");
            ...
            TAB: function(e, t) {
                ...
                function u(e) {
                    e = e.slice();
                    if (!y.before_cursor(false).match(/\s/)) {
                ...
                if (r) {
                    switch (get_type(r)) {
                        case "function":
                            var a = y.before_cursor(C.wordAutocomplete);
                            if (r.length === 3) {
                        ...
                        case "array":
                            ...
                            break;
                        default:
                            throw new $.terminal.Exception(p().invalidCompletion)
                    }
                } else {
                    t()
                }
                            ...
                            for (n = requests.length; n--;) {
                                ...
                                if (r.readyState !== 4) {
                                    try {
                                        ...
                                        if (is_function(C.exceptionHandler)) {
                                            C.exceptionHandler.call(y, t, "AJAX ABORT")
                                        } else {
                                            y.error(p().ajaxAbortError)
                                        }
                                    }
                                }
                            }
        ...
        function $e(e) {
            var t = B.top();
            if (x && (!A || !C.pauseEvents)) {
                if (is_function(t.keypress)) {
                    return t.keypress.call(y, e, y)
                } else if (is_function(C.keypress)) {
                    return C.keypress.call(y, e, y)
                }
            }
        }
            ...
            return function e(r, i) {
                ...
                if (r.length > 0) {
                    ...
                    var c = setInterval(function() {
                        if (!Ke) {
                            var e = $.terminal.substring(u, o, o + 1);
                            if (i.mask) {
                                var t = T.mask();
                                if (typeof t === "string") {
                                    e = t
        ...
        var Oe;
        if (y.is("body,html")) {
            if (y.hasClass("full-screen-terminal")) {
                var Le = y.find("> .terminal").data("terminal");
                if (Le) {
                    return Le
                }
            }
        ...
        } else if (y.data("terminal")) {
            return y.data("terminal")
        }
        var Ie = $.omap({
            id: function() {
                return D
            ...
            export_view: function() {
                ...
                return $.extend({}, {
                    ...
                    mask: T.mask(),
                    prompt: y.get_prompt(),
                    command: y.get_command(),
                    position: T.position(),
                    lines: clone(w.data()),
                    interpreters: B.clone(),
                    history: T.history().data
                }, e)
            },
            import_view: function(t) {
                if (g) {
                    throw new Error(sprintf(p().notWhileLogin, "import_view"))
                }
                _("onImport", [t]);
                f(function e() {
                    y.set_prompt(t.prompt);
                    y.set_command(t.command);
            ...
            save_state: function(e, t, n) {
                if (typeof n !== "undefined") {
                    save_state[n] = y.export_view()
                } else {
                    save_state.push(y.export_view())
                }
            ...
            autologin: function(e, t, n) {
                y.trigger("terminal.autologin", [e, t, n]);
                return y
            },
            login: function(r, u, a, o) {
                ...
                g = true;
                if (y.token() && y.level() === 1 && !tt) {
                    g = false;
                    y.logout(true)
                } else if (y.token(true) && y.login_name(true)) {
                    g = false;
                    if (is_function(a)) {
                        a()
                    }
                ...
                function i(e, t, n) {
                    ...
                    if (t) {
                        ...
                        if (u) {
                            if (!n) {
                                y.error(p().wrongPasswordTryAgain)
                            }
                            y.pop(undefined, true).set_mask(false)
                        } else {
                            g = false;
                            if (!n) {
                                y.error(p().wrongPassword)
                            }
                            y.pop(undefined, true).pop(undefined, true)
                        }
                        r = o
                    }
                    if (y.paused()) {
                    ...
                    y.off("terminal.autologin")
                }
                y.on("terminal.autologin", function(e, t, n, r) {
                    if (_("onBeforeLogin", [t, n]) === false) {
                        return
                    }
                    i(t, n, r)
                });
                y.push(function(n) {
                    y.set_mask(C.maskChar).push(function(e) {
                        try {
                            if (_("onBeforeLogin", [n, e]) === false) {
                                s();
                                return
                            }
                            y.pause();
                            var t = r.call(y, n, e, function(e, t) {
                                i(n, e, t)
                            });
            ...
            complete: function(r, i) {
                ...
                var a = y.before_cursor(i.word).replace(/\\"/g, '"');
                var s = false;
                if (i.word) {
                    if (a.match(/^"/)) {
                        s = '"'
                ...
                if (Ne % 2 === 0) {
                    He = y.before_cursor(i.word)
                } else {
                    var e = y.before_cursor(i.word);
                    if (e !== He) {
                        return
                    }
                }
                ...
                function p(e, t) {
                    var n = y.get_command();
                    var r = y.get_position();
                    var i = new RegExp("^" + e, "i");
                    var u = n.slice(0, r);
                    var a = n.slice(r);
                    var o = t.replace(i, "") + (s || "");
                    y.set_command(u + o + a);
                    y.set_position((u + o).length)
                }
                if (c.length === 1) {
                    if (i.escape) {
                        p(t, c[0])
                    } else {
                        y.insert(c[0].replace(f, "") + (s || ""))
                    }
                    He = y.before_cursor(i.word);
                    return true
                } else if (c.length > 1) {
                    if (++Ne >= 2) {
                        ...
                        if (i.echo) {
                            if (is_function(i.doubleTab)) {
                                ...
                                var D = i.doubleTab.call(y, a, c, h);
                                ...
                                y.echo($.terminal.escape_brackets(m), {
                                    keepWords: true,
                                    formatters: false
                                })
                            }
            ...
            pause: function(t) {
                l(function e() {
                    Ve();
                    A = true;
                    T.disable(t || is_android);
                    if (!t) {
                        T.find(".cmd-prompt").hidden()
                    }
                    _("onPause")
                });
                return y
            ...
            resume: function(i) {
                l(function e() {
                    A = false;
                    if (x && terminals.front() === y) {
                        T.enable(i)
                    }
                    T.find(".cmd-prompt").visible();
                    var t = Ze;
                    Ze = [];
                    for (var n = 0; n < t.length; ++n) {
                        y.exec.apply(y, t[n])
            ...
            geometry: function() {
                var t = window.getComputedStyle(y[0]);
            ...
            resize: function(e, t) {
                if (!y.is(":visible")) {
                    ...
                    var n = get_num_chars(y, I);
                    var r = get_num_rows(y, I);
                    if (n !== u || r !== a) {
                        y.clear_cache();
                        var i = n !== u;
                        u = n;
            ...
            flush: function(g) {
                ...
                f(function e() {
                    try {
                        ...
                        var t = y.is_bottom();
                        var u = C.scrollOnEcho && g.scroll || t;
                        var a;
                        var o = true;
                        var s = false;
                        var l = $();
                        ...
                        F.flush(function(e) {
                            if (!e) {
                                ...
                                if (g.update && e.raw === true && e.newline) {
                                    return
                                }
                                if (u) {
                        ...
                        if (l.length === 0) {
                            n.css("margin-left", 0);
                            r.css("top", 0);
                            T.__set_prompt_margin(0);
                            i = y.find(".terminal-output div:last-child" + " div:last-child");
                            ...
                            var p = c.width / L;
                            n.css("margin-left", p);
                            r.css("top", -c.height / L);
                            var D = y.geometry().char.width;
                            var m = Math.round(p / D);
                            T.__set_prompt_margin(m)
                        }
                        ie();
                        _("onFlush");
                        var d = y.find(".cmd-cursor");
                        var h = y.find(".cmd").offset();
                        var v = y.offset();
                        y.stopTime("flush").oneTime(1, "flush", function() {
                            css(y[0], {
                                "--terminal-height": y.height(),
                                "--terminal-x": h.left - v.left,
                                "--terminal-y": h.top - v.top,
                                "--terminal-scroll": y.prop("scrollTop")
                            });
                            if (x) {
                                d.hide();
                                y.oneTime(1, "flush", function() {
                                    d.show()
                                })
                            }
                        });
                        ...
                        if (is_function(C.exceptionHandler)) {
                            try {
                                C.exceptionHandler.call(y, e, "TERMINAL (Flush)")
                            } catch (e) {
            ...
            update: function(r, t, i) {
                f(function e() {
                    ...
                    if (!w.valid_index(r)) {
                        y.error("Invalid line number " + r)
                    } else if (t === null) {
                        w.update(r, null);
                        b.find("[data-index=" + r + "]").remove()
                    } else {
                        t = H(t, {
                            update: true,
                            line: r
                ...
                function t(i) {
                    try {
                        ...
                        if (u.typing) {
                            ...
                            var e = y.typing("echo", u.delay, i, u);
                            e.then(function() {
                                o.resolve()
                            });
                            return
                        ...
                        if (is_function(C.exceptionHandler)) {
                            C.exceptionHandler.call(y, e, "TERMINAL (echo)")
                        } else {
                ...
                f(function e() {
                    if (l()) {
                        if (t === "prompt") {
                            ...
                            with_prompt(y.get_prompt(), function(e) {
                                Se(e, n, u)
                            }, y)
                        } else if (t === "insert") {
                            with_prompt(y.get_prompt(), function(e) {
            ...
            logout: function(n) {
                ...
                f(function e() {
                    if (n) {
                        ...
                        y.set_token(undefined, true);
                        y.login.apply(y, t)
                    } else if (B.size() === 1 && y.token()) {
                        y.logout(true)
                    } else {
                        while (B.size() > 1) {
                            if (y.token()) {
                                y.logout(true).pop().pop()
                            } else {
                                y.pop()
                            }
                        }
            ...
            token: function(e) {
                return E.get(y.prefix_name(e) + "_token")
            },
            set_token: function(e, t) {
                var n = y.prefix_name(t) + "_token";
                if (typeof e === "undefined") {
                    E.remove(n)
                } else {
                    E.set(n, e)
            ...
            login_name: function(e) {
                return E.get(y.prefix_name(e) + "_login")
            },
            name: function() {
                return B.top().name
            },
            prefix_name: function(e) {
                var t = (C.name ? C.name + "_" : "") + D;
                if (e && B.size() > 1) {
            ...
            read: function(e, t, n) {
                ...
                if (r.typing) {
                    var i = y.get_prompt();
                    r.typing = false;
                    return y.typing("prompt", r.delay, e).then(function() {
                        return y.set_prompt(i).read(e, r)
                    })
                }
                Me = true;
                    ...
                    G(a, o.login, function(e) {
                        ...
                        if (r.completion === true) {
                            if ($.isArray(e.completion)) {
                                B.top().completion = e.completion
                            } else if (!e.completion) {
                                B.top().completion = false
                            }
                        }
                        if (r.login) {
                            var t;
                            ...
                            if (n === "function") {
                                t = r.infiniteLogin ? $.noop : y.pop;
                                y.login(r.login, r.infiniteLogin, u, t)
                            } else if (get_type(a) === "string" && n === "string" || n === "boolean") {
                                t = r.infiniteLogin ? $.noop : y.pop;
                                y.login(X(a, r.login), r.infiniteLogin, u, t)
                            }
                        } else {
                            u()
                        }
            ...
            keymap: function(e, n) {
                ...
                if (typeof n === "undefined") {
                    if (typeof e === "string") {
                        ...
                        e = $.extend({}, N, $.omap(e || {}, function(n, r) {
                            if (!N[n]) {
                                return r.bind(y)
                            }
                            return function(e, t) {
                                return r.call(y, e, function() {
                                    return N[n](e, t)
                                })
                            }
                        }));
                        T.keymap(null).keymap(e)
                    }
                    ...
                    if (!N[r]) {
                        ...
                        T.keymap(r, function(e, t) {
                            return n.call(y, e, function() {
                                return N[r](e, t)
                            })
                        })
                    }
            ...
            purge: function() {
                f(function e() {
                    var t = y.prefix_name() + "_";
                    var n = E.get(t + "interpreters");
                    if (n) {
                        $.each(JSON.parse(n), function(e, t) {
                            E.remove(t + "_commands");
                            E.remove(t + "_token");
                            E.remove(t + "_login")
                        })
                    }
                    T.purge();
                    E.remove(t + "interpreters")
                });
                return y
            },
            destroy: function() {
                f(function e() {
                    T.destroy().remove();
                    y.resizer("unbind");
                    y.touch_scroll("unbind");
                    it.resizer("unbind").remove();
                    ut.resizer("unbind").remove();
                    $(document).unbind(".terminal_" + y.id());
                    $(window).unbind(".terminal_" + y.id());
                    y.unbind("click mousedown mouseup");
                    y.removeData("terminal").removeClass("terminal").unbind(".terminal");
                    if (C.width) {
                        y.css("width", "")
                    }
                    if (C.height) {
                    ...
                    y.find(".terminal-fill, .terminal-font, .terminal-scroller").remove();
                    y.stopTime();
                    terminals.remove(D);
                    if (S) {
                        if (S.unobserve) {
                    ...
                    var t = y.find(".terminal-scroll-marker");
                    if (Ye) {
                        Ye.unobserve(t[0])
                    }
                    t.remove();
                    ...
                    if (is_mobile) {
                        y.off(["touchstart.terminal", "touchmove.terminal", "touchend.terminal"].join(" "))
                    }
                    b.remove();
                    j.remove();
                    if (Oe) {
            ...
            scroll_to: function(e) {
                var t = R.scrollTop() - y.offset().top + $(e).offset().top;
                R.scrollTop(t);
                return y
            },
            scroll_to_bottom: function() {
                var e;
                if (y.prop) {
                    e = R.prop("scrollHeight")
                } else {
                    e = R.attr("scrollHeight")
                }
                R.scrollTop(e);
                return y
            },
            ...
            return function() {
                ...
                try {
                    return e.apply(y, [].slice.apply(arguments))
                } catch (e) {
                    if (t !== "exec" && t !== "resume") {
        ...
        $(document).bind("ajaxSend.terminal_" + y.id(), function(e, t) {
            requests.push(t)
        });
        var R = $('<div class="terminal-scroller"/>').appendTo(y);
        var j = $('<div class="terminal-wrapper"/>').appendTo(R);
        $(broken_image).hide().appendTo(j);
        var it = $('<div class="terminal-font">&nbsp;</div>').appendTo(y);
        var ut = $('<div class="terminal-pixel"/>').appendTo(y);
        var O = $('<div class="terminal-fill"/>').appendTo(R);
        b = $("<div>").addClass("terminal-output").attr("role", "log").appendTo(j);
        y.addClass("terminal");
        var L = ft();
        var I = get_char_size(y);
        var at = !terminal_ready(y);
        if (C.login && _("onBeforeLogin") === false) {
            tt = false
        }
        var ot;
        if (typeof e === "string") {
            ...
            for (var z = 0, st = e.length; z < st; ++z) {
        ...
        if (is_function(C.login)) {
            P = C.login
        } else if (ot && (typeof C.login === "string" || C.login === true)) {
            P = X(ot, C.login)
        }
        terminals.append(y);
        ...
        function ct() {
            nt = x;
            y.disable().find(".cmd textarea").trigger("blur", [true])
        }
        ...
        function pt(e) {
            ...
            if (get_type(e) !== "string") {
                if (is_function(C.parseObject)) {
                    ...
                    e = $.terminal.columns(e, y.cols(), C.tabs)
                } else {
                    e = String(e)
                }
            }
        ...
        $(document).on("paste.terminal_" + y.id(), mt);
        var N = $.extend({}, Ee, $.omap(C.keymap || {}, function(n, r) {
            if (!Ee[n]) {
                return r.bind(y)
            }
            return function(e, t) {
        ...
        G(e, C.login, function(e) {
            ...
            function n(e) {
                ...
                if (e) {
                    ...
                    if (!$(t).closest(".terminal").length && y.enabled()) {
                        y.disable()
                    }
                }
            }
            y.oneTime(100, function() {
                $(document).bind("click.terminal_" + y.id(), n).bind("contextmenu.terminal_" + y.id(), n)
            });
            var r = $(window);
            ...
            if (is_mobile) {
                (function() {
                    ...
                    y.on("touchstart.terminal", function(e) {
                        e = e.originalEvent;
                ...
                r.on("focus.terminal_" + y.id(), lt).on("blur.terminal_" + y.id(), ct);
                var h;
                (function() {
                    var t = 0;
                    var n;
                    var r = "click_" + y.id();
                    var i = y.find(".cmd textarea");

                    function u() {
                        if (n.is(".terminal") || n.is(".terminal-wrapper")) {
                            var e = y.get_command().length;
                            y.set_position(e)
                ...
                (function() {
                    ...
                    y.on(e, function(e) {
                        ...
                        if (h) {
                            ...
                            m.attr("style", [style_prop("left", o, true), style_prop("top", a, true), style_prop("width", l, true), style_prop("height", s, true)].join(";"));
                            if (!m.is(":focus")) {
                                m.focus()
                            }
                            y.stopTime("textarea");
                            y.oneTime(100, "textarea", function() {
                                var e = {
                                    left: "",
                                    top: "",
                                    width: "",
                                ...
                                if (!is_css_variables_supported) {
                                    var t = y.find(".cmd .cmd-cursor-line").prevUntil(".cmd-prompt").length;
                                    e.top = t * 14 + "px"
                                }
                                m.css(e)
                            });
                            y.stopTime("selection");
                            y.everyTime(20, "selection", function() {
                                if (m[0].selection !== m[0].value) {
                                    if (get_textarea_selection(m[0])) {
                                        clear_textarea_selection(m[0]);
                                        select(y.find(".terminal-output")[0], y.find(".cmd div:last-of-type")[0]);
                                        y.stopTime("selection")
                                    }
                                }
                            })
                ...
                y.on("scroll", function() {
                    var e = y.find("textarea");
                    var t = y[0].getBoundingClientRect();
                    var n = y[0].scrollHeight;
                    var r = R.scrollTop();
                    var i = n - (r + t.height);
                    if (i === 0) {
                        e.css("top", "")
            ...
            function i() {
                ...
                I = get_char_size(y);
                if (e !== I.width) {
                    T.option("charWidth", I.width).refresh()
                }
            }
            u();
            ...
            function s() {
                if (window.IntersectionObserver) {
                    var e = $('<div class="terminal-scroll-marker"/>').appendTo(R);
                    var t = e;
                    if (C.scrollBottomOffset !== -1) {
                        var n = style_prop("height", C.scrollBottomOffset);
                        t = $('<div style="' + n + '"/>').appendTo(e)
                    }
                    Ye = new IntersectionObserver(o, {
                        root: y[0]
                    });
                    Ye.observe(t[0])
                }
            ...
            function l() {
                ...
                function n() {
                    if (y.is(":visible") && !t) {
                        ...
                        j.css("visibility", "")
                    } else if (t && !y.is(":visible")) {
                        t = false;
                        e = $.terminal.active() === y && y.enabled();
                        y.disable();
                        j.css("visibility", "hidden")
                    }
                }
                if (window.IntersectionObserver && y.css("position") !== "fixed") {
            ...
            qe.resolve();
            if (x && y.is(":visible") && !is_mobile) {
                y.focus(undefined, true)
            } else {
                y.disable()
            }
            if (is_function(P)) {
            ...
            if (C.execHash) {
                ...
                var i = false;
                $(document).bind("keydown.terminal_" + y.id(), function(e) {
                    if (e.shiftKey) {
                        i = true
                    }
                }).bind("keyup.terminal_" + y.id(), function(e) {
                ...
                function n(e, t) {
                    if (!i) {
                        ...
                        if (is_function(n.mousewheel)) {
                            r = n.mousewheel(e, t, y)
                        } else if (is_function(C.mousewheel)) {
                            r = C.mousewheel(e, t, y)
                        }
                        if (r === true) {
                            return
                        }
