...
class Recorder:
    def __init__(self, filename="temp_video.avi"):
        self.start_time = 0
        self.end_time = 0
...
class VideoRecorder(Recorder):
    ...
    def __init__(self, filename="temp_video.avi", fourcc="MJPG", sizex=640, sizey=480, camindex=0, fps=30):
...
def stop_AVrecording(filename="test"):
    ...
    elapsed_time = video_thread.length
